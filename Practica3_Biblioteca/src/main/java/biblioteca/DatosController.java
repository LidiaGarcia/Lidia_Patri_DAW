...
//		personas_repo.save(p5);
		...
		ReservaSala rs4 = new ReservaSala(s1,p4, LocalDate.of(2015, 5, 24), LocalTime.of(16,00),false);
		...
		ReservaSala rs6 = new ReservaSala(s1,p4, LocalDate.of(2015, 5, 24), LocalTime.of(18,00),false);
